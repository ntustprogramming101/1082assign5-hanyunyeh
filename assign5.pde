...
void draw() {
  ...
  for(int i = 0; i < cabbageX.length; i++){
   ...
   if(playerHealth < PLAYER_MAX_HEALTH &&isHit(cabbageX[i],cabbageY[i],SOIL_SIZE,SOIL_SIZE,playerX,playerY,SOIL_SIZE,SOIL_SIZE)== true) { 
      playerHealth ++;
    ...
    for(int i = 0; i < clockX.length; i++){
        ...
        if(playerHealth < PLAYER_MAX_HEALTH &&isHit(clockX[i],clockY[i],SOIL_SIZE,SOIL_SIZE,playerX,playerY,SOIL_SIZE,SOIL_SIZE)== true) { 
        addTime(15);
        hitClock = true;
      ...
      if(playerHealth < PLAYER_MAX_HEALTH &&isHit(soldierX[i],soldierY[i],SOIL_SIZE,SOIL_SIZE,playerX,playerY,SOIL_SIZE,SOIL_SIZE)== true) { 
